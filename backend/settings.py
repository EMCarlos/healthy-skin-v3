...
DEBUG = True
ALLOWED_HOSTS = ['127.0.0.1', 'localhost', 'healthyskin.herokuapp.com', 'healthy-skin-v3-feb7e40fa621.herokuapp.com', 'www.healthyskinaruba.com', 'healthyskinaruba.com', "healthy-skin-v3.vercel.app"]
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('SUPABASE_DB_NAME'),        # often 'postgres'
        'USER': os.environ.get('SUPABASE_DB_USER'),        # your user, not 'postgres'
        'PASSWORD': os.environ.get('SUPABASE_DB_PASSWORD'),
        'HOST': os.environ.get('SUPABASE_DB_HOST'),
        'PORT': os.environ.get('SUPABASE_DB_PORT', '6543'),  # <-- IMPORTANT: 6543 for pgBouncer
        'CONN_MAX_AGE': 60,  # Use connection pooling (recommended for pgBouncer)
    }
}
